								...
								<!-- Sidebar -->
									<section>
										...
										<div class="side-section top-side">
											<a href="#" class="bordered-feature-image"><img src="images/pic{$popust.idsmjestaj}.jpg" alt="{$popust.naziv}" /></a>
											<span>Needed bonus points: {$popust.bonus}</span><br />
											<span>Discount: {$popust.popust}%</span><br />
											<span>Valid from {$popust.datumstart} to {$popust.datumend}</span><br />
											<a href="rezervacija.php?id={$popust.idsmjestaj}&popust={$popust.id}">Book</a>
										</div>
									</section>
							</div>
							{/foreach}
