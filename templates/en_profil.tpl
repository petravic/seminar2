							...
							<div class="6u skel-cell-important">
								...
								<!-- Main Content -->
									<section>
										...
										<p class="profil-info">
											<span>Name:</span> {$ime}<br />
											<span>Last name:</span> {$prezime}<br />
											<span>Adress:</span> {$adresa}<br />
											<span>Location:</span> {$mjesto}<br />
											<span>District:</span> {$zupanija}<br />
											<span>Phone:</span> {$telefon}<br />
											<span>OIB:</span> {$oib}<br />
											<span>Date of birth:</span> {$datum}<br />
										</p>
									</section>
