							...
							<div class="6u skel-cell-important">
								...
								<!-- Main Content -->
									<section>
										...
										<p class="profil-info">
											<span>Korisničko ime:</span> {$username}<br />
											<span>Email:</span> {$email}<br />
										</p>
										<p class="profil-info">
											<span>Ime:</span> {$ime}<br />
											<span>Prezime:</span> {$prezime}<br />
											<span>Adresa:</span> {$adresa}<br />
											<span>Mjesto:</span> {$mjesto}<br />
											<span>Županija:</span> {$zupanija}<br />
											<span>Broj telefona:</span> {$telefon}<br />
											<span>OIB:</span> {$oib}<br />
											<span>Datum rođenja:</span> {$datum}<br />
										</p>
									</section>
